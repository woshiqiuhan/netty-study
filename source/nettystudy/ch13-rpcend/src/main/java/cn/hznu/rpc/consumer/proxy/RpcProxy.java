package cn.hznu.rpc.consumer.proxy;

import cn.hznu.rpc.codec.RpcDecoder;
import cn.hznu.rpc.codec.RpcEncoder;
import cn.hznu.rpc.protocol.RpcMessage;
import cn.hznu.rpc.protocol.RpcRequest;
import cn.hznu.rpc.protocol.RpcResponse;
...
public class RpcProxy {
    ...
    private static class MethodProxy implements InvocationHandler {
        ...
        public Object rpcInvoke(Object proxy, Method method, Object[] args) throws InterruptedException {
            ...
            RpcMessage rpcMessage = RpcMessage.builder().rpcMessage(rpcRequest).build();
            ...
            return ((RpcResponse) consumerHandler.getResponse()).getRpcResponse();
        }
    }
}